# -*- coding: utf-8 -*-
"""
Created on Thu Aug  5 09:01:38 2021
...
ERA5_folder = r'I:\Precipitation\ERA5'
...
era5_years = np.arange(1981,2021)
for era5_year in era5_years[37:38]:
     print(era5_year)
     fn = 'ERA5_Total_Precip_'+str(int(era5_year))+'.nc'
     era5_file = os.path.join(ERA5_folder,fn)
     test=xr.open_dataset(era5_file)
...
cmaids = nodes[(nodes.CMAID<201805)&(nodes.CMAID>201803)].CMAID.unique()
#cmaids = nodes[nodes.CMAID>200026].CMAID.unique()
#%% 
#example 201805 Ewiniar 20180601-20180612
